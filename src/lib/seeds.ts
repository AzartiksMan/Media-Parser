...
export const SEED_SITES: SeedSite[] = [
  ...
  // More English movies/series
  { domain: "lookmovie2.to", region: ["us", "uk"], contentType: ["movies", "series"], brand: "lookmovie" },
  { domain: "dopebox.to", region: ["us", "uk"], contentType: ["movies", "series"], brand: "dopebox" },
  { domain: "moviesjoy.is", region: ["us", "uk"], contentType: ["movies", "series"], brand: "moviesjoy" },
  { domain: "cinezone.to", region: ["us", "uk"], contentType: ["movies", "series"], brand: "cinezone" },
  { domain: "cataz.to", region: ["us", "uk"], contentType: ["movies", "series"], brand: "cataz" },
  { domain: "himovies.to", region: ["us", "uk"], contentType: ["movies", "series"], brand: "himovies" },
  ...
  { domain: "sflix.to", region: ["us", "uk"], contentType: ["movies", "series"], brand: "sflix" },
  ...
  { domain: "nflstreams.to", region: ["us", "uk"], contentType: ["sports"], brand: "nflstreams" },
  { domain: "mlbstreams.to", region: ["us", "uk"], contentType: ["sports"], brand: "mlbstreams" },
  { domain: "nhlstreams.to", region: ["us", "uk"], contentType: ["sports"], brand: "nhlstreams" },
